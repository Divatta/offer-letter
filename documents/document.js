...
module.exports = ({name,position,joiningDate,ctc})=>{
                  ...
                  <div className="card card-shadow">
                      ...
                      <div className="card-body mt-3 offerBody">
                          ...
                          <p style="margin-top: 30px;">${today.getDate()}/${today.getMonth()}/${today.getFullYear()}
                              <br /><br />
                              <b >Sub :</b> Offer of employment as ${position}
                              <br /><br />
                              Dear ${name},
                              ...
                              of ${position} at Be-Practical Pvt. Ltd. We feel confident
                              that you will contribute your skills and experience towards the growth of our organization.
                              <br /><br />
                              As per the discussion, your starting date will be on ${joiningDate}. The terms and conditions of your employment
                              and your job responsibilities are enlocsed as annexure A.
                              <br /><br />
                              Your CTC package will be ${ctc} lacs p.a. You may please contact the HR department for the necessary break-up. We
