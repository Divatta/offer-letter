...
const dash = require('./client/src/components/SendMail/CreateOffer')


// const pdfTemplate = new BootstrapEmail(pdfTemplate1)

exports.createPdf = (req,res) => {
    pdf.create(pdfTemplate(req.body)).toFile('OfferLetter.pdf',(err) => {
        if(err){
            console.log(err);
        }
...
exports.fetchPdf = (req,res) => {
    // res.sendFile(path.join(path.dirname(__dirname), 'OfferLetter.pdf'))
...
exports.sendPdf = (req,res) => {
    ...
    // pathToAttachment = path.join(path.dirname(__dirname),'OfferLetter.pdf')
